<?php
class Admin_Model_Otherdomains extends Nadeb_Model_Crud
{
	public function __construct()
	{
    	$this->tb = new Application_Model_Db_OtherDomains();
	...
	public function data_grid($params = null)
	{
		...
		$grid->title('Listagem de conteúdos para outros dominios');
...
// 		$grid->tools['move']     = __LINKS__ . 'admin/'. $this->_params->controller .'/save-order/';
		...
		$grid->columns           = array('Dominio','Titulo');
		$grid->rows              = array(
										'domainName' => 'tm100',
										'title'      => 'tm250',
// 										'active'     => array('tm30',  'swap', __LINKS__ . 'admin/' . $this->_params->controller)
	...
	public function data_form($id = null, $post)
	{
		...
		$form->file      ('banner','Banner(1000 x 180)');
